...
public class Tabuleiros extends Jogos{
    ...
    public Tabuleiros(String nomeProd, double preco, int ano, int codigoProd, String faixaEtaria, int disponiveis, int alugados, String numJogadores, String tipo, String marca) {
