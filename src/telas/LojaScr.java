 ...
 * @author Adm
 */
public class LojaScr extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LojaScr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
